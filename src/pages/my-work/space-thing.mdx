...
<MyWorkMeta
  title="KyeSmith.me - Space-Thing"
  description="Kye Smith's space 'simulator'"
  keywords={['kye', 'smith', 'react', 'next', 'typescript', 'space-thing']}
/>
...
a few solar systems on page load. Each of these systems would consist of one star and 1 - “a few”
