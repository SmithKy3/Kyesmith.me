...
import { EasyImage } from 'components/common/EasyImage';

<MyWorkMeta
  title="KyeSmith.me - UoS EEE Society Logo"
  description="Kye Smith's designing of Sheffield University's new EEE society logo"
  keywords={['kye', 'smith', 'sheffield']}
/>
...
<EasyImage
  imgFileName="eee-logo-final.png"
  style={{ width: '80%', margin: '.5rem auto' }}
/>
