...
})(["position:absolute;z-index:10;top:0;left:0;width:100%;height:100%;background:", ";border:3px solid ", ";transform:rotateX(0deg) rotateY(0deg);transition:transform 0.25s;"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.cloud, _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.cloud);
...
})(["position:absolute;top:25%;left:20%;width:60%;max-height:65%;overflow-y:scroll border-width:0 0 0 10px;border-color:", ";text-align:justify;font-family:'Baloo Chettan 2';font-weight:400;font-size:1.25vw;color:", ";@media screen and (max-width:600px){font-size:2.5vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.teal, _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
//# sourceMappingURL=index.js.a619e61754f57d358871.hot-update.js.map