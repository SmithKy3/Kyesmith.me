...
})(["position:fixed;z-index:10;top:2vh;right:", "vw;transition:right 1s;width:30vw;height:8vh;background:none;"], function (props) {
...
})(["display:", ";position:absolute;top:0;left:0;width:6vw;height:7vh;background:white;text-align:left;color:", ";font-size:1.5vw;font-family:'Baloo Chettan 2';font-weight:400;&:hover{cursor:pointer;}@media screen and (max-width:600px){font-size:3vw;}"], function (props) {
...
})(["margin:0 0 0 80%;width:3vh;height:3vh;text-decoration:none;border:none;font-size:2vw;font-weight:800;color:", ";background:white;&:hover{cursor:pointer;}&:focus{outline:none;}@media screen and (max-width:600px){font-size:3vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_7__["colors"].theme.teal);
...
})(["display:", ";position:absolute;top:0;right:0;width:12vw;height:max-content;padding:10px;background:white;"], function (props) {
...
//# sourceMappingURL=index.js.a41eb616f37cad66d293.hot-update.js.map