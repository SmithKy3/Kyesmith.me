...
})(["position:fixed;z-index:-1;top:20vh;left:30vw;width:40vw;height:50vh;perspective:50px;@media screen and (max-width:600px){width:70vw;height:70vh;top:15vh;left:15vw;}"]);
...
})(["position:absolute;top:5%;left:0;width:100%;height:10%;text-align:center;font-family:Calistoga;font-size:2vw;color:", ";@media screen and (max-width:600px){font-size:4vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
})(["position:absolute;top:20%;left:15%;width:60%;max-height:65%;padding-left:5%;border-width:0 0 0 5px;border-style:solid;border-color:", ";text-align:justify;font-family:'Baloo Chettan 2';font-weight:400;font-size:1vw;color:", ";@media screen and (max-width:600px){font-size:3vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.suburst, _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
//# sourceMappingURL=index.js.80485c8360fee8810be4.hot-update.js.map