...
})(["position:absolute;top:20%;left:15%;width:60%;max-height:75%;overflow-y:scroll;padding-left:5%;border-width:0 0 0 5px;border-style:solid;border-color:", ";text-align:justify;font-family:'Baloo Chettan 2';font-weight:400;font-size:1vw;color:", ";&::-webkit-scrollbar{display:none;}-ms-overflow-style:none;@media screen and (max-width:600px){top:15%;font-size:4vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.suburst, _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
//# sourceMappingURL=index.js.635212819f79d8db793f.hot-update.js.map