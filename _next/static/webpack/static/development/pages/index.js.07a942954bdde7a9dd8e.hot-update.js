...
})(["position:absolute;top:5%;left:0;width:100%;height:10%;text-align:center;font-family:Calistoga;font-size:2vw;color:", ";@media screen and (max-width:600px){font-size:3vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
})(["position:absolute;top:20%;left:20%;width:60%;max-height:65%;overflow-y:scroll;padding-left:5px;border-width:0 0 0 10px;border-style:solid;border-color:", ";text-align:justify;font-family:'Baloo Chettan 2';font-weight:400;font-size:1vw;color:", ";@media screen and (max-width:600px){font-size:2.5vw;}"], _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.teal, _contsants__WEBPACK_IMPORTED_MODULE_2__["colors"].theme.stormBlue);
...
//# sourceMappingURL=index.js.07a942954bdde7a9dd8e.hot-update.js.map